# Powerlevel10k preset shipped with Pro-Terminal-Setup-For-AI-Devs.
# Installed to ~/.p10k.zsh when none exists. Re-style anytime with: p10k configure
# Generated by Powerlevel10k configuration wizard on 2022-06-13 at 11:27 PDT.
